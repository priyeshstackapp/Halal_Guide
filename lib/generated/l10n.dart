...
class S {
  ...
  /// `Please Donate (Optional)`
  String get pleaseDonate {
    return Intl.message(
      'Please Donate (Optional)',
      name: 'pleaseDonate',
      desc: '',
  ...
  /// `Please select meal for charity`
  String get please_select_meal_for_charity {
    return Intl.message(
      'Please select meal for charity',
      name: 'please_select_meal_for_charity',
      desc: '',
      args: [],
    );
  }
