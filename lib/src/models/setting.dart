...
class Setting {
  ...
  Setting.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      defaultTax = jsonMap['default_tax'] == null ? 0.0:double.tryParse(jsonMap['default_tax']) ?? 0.0; //double.parse(jsonMap['default_tax'].toString());
      defaultCurrency = jsonMap['default_currency'] ?? '';
      currencyDecimalDigits =jsonMap['default_currency_decimal_digits'] == null ? 2 : int.tryParse(jsonMap['default_currency_decimal_digits']) ?? 2;
